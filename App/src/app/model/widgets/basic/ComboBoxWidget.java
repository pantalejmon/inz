...
public class ComboBoxWidget extends Widget {
    ...
    public ComboBoxWidget(Project projekt, String Name) throws IOException {
        super(projekt, Name);
    ...
    public void Draw(FXMLDrawPreviewController preview) {
        ...
        preview.getGc().fillText(text, preview.getTempX() + coX + 5, preview.getTempY() + coY + prefHeight / 2 + 6,
                prefWidth);
    ...
    public Element getCode(Document doc) {
        ...
        Attr text = doc.createAttribute("promptText");
